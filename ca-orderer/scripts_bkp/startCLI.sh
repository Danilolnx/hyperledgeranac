...
# Create channel
peer channel create -o orderer.anacord.gov.br:7050 -c $CHANNEL_NAME -f /channel-artifacts/channel.tx --tls --cafile /crypto/ordererOrganizations/gov.br/orderers/orderer.anacord.gov.br/msp/tlscacerts/ca-cert.pem
...
CORE_PEER_MSPCONFIGPATH=/crypto/peerOrganizations/anacpool.gov.br/users/Admin.anacpool.gov.br/msp \
CORE_PEER_TLS_ROOTCERT_FILE=/crypto/peerOrganizations/anacpool.gov.br/peers/peer0.anacpool.gov.br/tls/ca.crt \
peer channel update -o orderer.anacord.gov.br:7050 -c $CHANNEL_NAME -f /channel-artifacts/anacpoolMSPanchors.tx --tls --cafile /crypto/ordererOrganizations/gov.br/orderers/orderer.anacord.gov.br/msp/tlscacerts/ca-cert.pem
